# Generated by Powerlevel10k configuration wizard on 2023-01-12 at 10:56 AEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_INSTANT_PROMPT=quiet  # I chose this because I like to print reminders to myself when I open a new terminal
