...
echo "  To use visidata as the pager app in psql, export this before running psql:"
echo "    \`export PAGER='vd --filetype=tsv --delimiter=\"|\" --undo=true --header=1 -'\`"
echo "  To use visidata as the pager for fixed with outputs such a docker or kubectl, pipe the output into visidata:"
echo "    \`docker ps | vd -f fixed\`"
echo ""
